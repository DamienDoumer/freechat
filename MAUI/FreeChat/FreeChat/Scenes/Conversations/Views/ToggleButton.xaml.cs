...
namespace FreeChat.Scenes.Conversations.Views;
...
public partial class ToggleButton : ContentView
{
    ...
    public static readonly BindableProperty IsToggledProperty = BindableProperty.Create(nameof(IsToggled), typeof(bool),
        typeof(ToggleButton), defaultValue: true, propertyChanged: (obj, old, newV) =>
        {
            var me = obj as ToggleButton;
    ...
    {
        IsToggled = true;
        if (ToggleCommand?.CanExecute(IsToggled) ?? false)
        {
